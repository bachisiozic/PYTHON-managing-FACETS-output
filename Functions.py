...
def file_collapsing(WD, PATTERN, output_collapsed_file):
    os.chdir(WD)
    ...
    # Write new_header, newline character, and DEF list to a file
...
#### . . . - Check the alterated GISTIC peaks
def GetAlteratedGISTICpeaks(file1_path, file2_path, output_file):
...
#### . . . - Create a heatmap
def create_heatmap(abnormal_df, output_file):
    # Create a heatmap
